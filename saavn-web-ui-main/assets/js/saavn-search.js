    ...
    results_objects[song_id] = {
      ...
      <div class="row" style="margin:auto;">
          ...
          <div class="col" style="border-style:none;padding:2px;">
              ...
              <button class="btn btn-success song-btn" type="button" style="margin:0px 2px;" onclick='AddToPlaylist("${song_id}")'>➕</button>
              <button class="btn btn-outline-light song-btn" type="button" style="margin:0px 2px;" onclick='ToggleLike("${song_id}")'>❤️</button>
